...
export type TodolistActionType=RemoveTodolistActionType|AddTodolistActionType|ChangeTodolistFilterActionType|ChangeTodolistTitleActionType
...
export const todolistReducer = (state: Array<TodolistsTaskType>, action: TodolistActionType) => {
    switch (action.type) {
        ...
        case 'ADD-TODOLIST':
            let newTodolist:TodolistsTaskType={id:v1(), todolistTitle:action.newTodolistTitle, filter:'all'}
